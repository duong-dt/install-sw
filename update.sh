...
# common tool
sudo nala install -y --update jq xclip zbar-tools vlc git easytag clementine sourcegit copyq unrar syncthing \
homebank qbittorrent zsh borgbackup yakuake meld ibus ibus-gtk ibus-unikey ibus-hangul nala megasync \
